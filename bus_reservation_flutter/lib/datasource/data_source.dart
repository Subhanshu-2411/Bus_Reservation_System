import 'package:bus_reservation_flutter/models/bus_reservation.dart';
import 'package:bus_reservation_flutter/models/bus_schedule.dart';
...
abstract class DataSource {
    ...
    Future<ResponseModel> addReservation(BusReservation busReservation);
    Future<List<BusReservation>> getAllReservation();
    Future<List<BusReservation>> getReservationsByMobile(String mobile);
    Future<List<BusReservation>> getReservationsByScheduleAndDeparture(int scheduleId, String departureDate);
